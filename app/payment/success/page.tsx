              ...
              <Card className="w-full">
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    {error ||
                      "We couldn't verify your payment. Please check your wallet balance or try again."}
                  </p>

                  <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4 mb-6">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      <strong>Note:</strong> If you completed the payment, it
                      may take a few minutes to reflect in your wallet. Please
                      check your transaction history or contact support if the
                      issue persists.
                    </p>
                  </div>
